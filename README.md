# HTML Meta Tags management package available for Laravel 6.x
...
'providers' => [
    '...',
    Siberfx\LaraMeta\MetaServiceProvider::class
];

'aliases' => [
    '...',
    'Meta'    => Siberfx\LaraMeta\Facade::class,
];
```
...
```
php artisan vendor:publish --provider="Siberfx\LaraMeta\MetaServiceProvider"
```
...
<html>
    <head>
        ...
        <meta name="author" content="Siberfx - info@siberfx.com" />
...
$Meta = new Siberfx\LaraMeta\Meta($config);
